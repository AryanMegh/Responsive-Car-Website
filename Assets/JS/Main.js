...
function activeFeatured() {
    LinkFeatured.forEach(l => l.classList('active-featured'))
...
sr.reveal('.home__button', { delay: 500, interval: 100, origin: 'bottom' })
sr.reveal('.about__group', '.about__data' { origin: 'left' })
